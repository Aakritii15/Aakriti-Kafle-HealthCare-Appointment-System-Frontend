                              ...
                              {m.type === "prescription" ? (
                                <div className="space-y-2">
                                  ...
                                  <div className="bg-white/10 rounded-lg p-3">
                                    <p className="text-sm font-medium mb-2">{m.prescriptionFileName || "Medical File"}</p>
                                    <a
                                      href={`${BASE}${m.prescriptionUrl}`}
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-2 bg-white text-green-600 px-3 py-2 rounded-lg text-sm font-medium hover:bg-green-50 transition-colors"
                                    >
